(function (root) {
  ...
  const STATE_SCHEMA = Object.freeze({
    ...
    leftRatio: Object.freeze({ default: null }),
    topRatio: Object.freeze({ default: null }),
    ...
    expandedLeftRatio: Object.freeze({ default: null }),
    expandedTopRatio: Object.freeze({ default: null }),
  ...
  const constants = Object.freeze({
    ...
    SITE_DATA_CACHE_TTL: 60 * 60 * 1000,
    AVATAR_MEMORY_CACHE_MAX_BYTES: 1024 * 1024,
    AVATAR_MEMORY_CACHE_ENTRY_MAX_BYTES: 64 * 1024,
  ...
  const mutableStateKeys = Object.freeze([
    ...
    "overlayAutoCollapsed",
    "overlayAwaitingOpenUntil",
    "overlaySuppressed",
    "overlayObserver",
    "overlayListenersBound",
    "overlaySyncFrame",
    "overlaySettleTimer",
    "overlaySettleAttempts",
  ...
  function installGlobalAccessors() {
    const constantKeys = [
      ...
      "SITE_DATA_CACHE_TTL",
      "AVATAR_MEMORY_CACHE_MAX_BYTES",
      "AVATAR_MEMORY_CACHE_ENTRY_MAX_BYTES",
